...
## Export results
write.table(abundance_tableTccfiltered, file=file.path(here::here(), "data", "derived_data", "2022_COI_JRLAT_cleaned_filtered_abundance.txt"), sep="\t", row.names=FALSE, col.names=TRUE, quote=FALSE)
```
