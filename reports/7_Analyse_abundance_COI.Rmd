...
phyloseq.extended::plot_composition(carbom, "kingdom", "Bacteria", "family", fill = "Species", numberOfTaxa = 11) +
  facet_grid(~Type, scales = "free_x", space = "free_x")

phyloseq.extended::plot_composition(carbom, "kingdom", "Bacteria", "family", fill = "Species", numberOfTaxa = 9) + 
  facet_grid(~Type+Fruit+Status+Population, scales = "free_x", space = "free_x")
p <-phyloseq.extended::plot_composition(carbom_higher400, "kingdom", "Bacteria", "family", fill = "Species", numberOfTaxa = 9) + 
  facet_grid(~Type+Fruit+Status+Population, scales = "free_x", space = "free_x")
p
...
phyloseq.extended::plot_composition(carbom_rare_higher400, "kingdom", "Bacteria", "family","Species", fill = "Species", numberOfTaxa = 9)
phyloseq.extended::plot_composition(carbom_rare_higher400, "kingdom", "Bacteria", "family","Species", fill = "Species", numberOfTaxa = 9) + 
  facet_grid(~Type+Fruit+Status+Population, scales = "free_x", space = "free_x")
