...
taxonomy$species[taxonomy$family=="NA"|taxonomy$family=="no data"] <- "Unknown"
...
## Remove samples with coverage lower than larvae (I'll see after)
```{r}
...
#dataCOI$count <- as.character(dataCOI$count)
...
carbom <- phyloseq::phyloseq(OTU, TAX, sample_names)
