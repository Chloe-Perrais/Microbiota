...
sample<-read.csv("BD_metadata.csv",row.names=1,sep="\t") #to modify (name of the metadata file)
sample<-sample_data(sample)

rawname<-"BD-cleaned_abundance.csv" #to modify (input tsv file from Frogs)
